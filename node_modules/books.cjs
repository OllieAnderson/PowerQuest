...
What it is:
A golden-orange berry native to cold, boggy regions in the Northern Hemisphere — especially in Scandinavia, Russia, Alaska, and northern Canada.

Key Features:
Looks like:
A small, amber-colored raspberry with juicy, soft flesh.

Taste:
Tart when fresh, mellow and honey-sweet when overripe or cooked.

Texture:
Soft, almost creamy when ripe; a bit seedy like raspberries.

Growth habitat:
Grows wild in wetlands and tundra. Hard to cultivate — most are handpicked.

Culinary Uses:
Jam and preserves – common in Sweden and Finland.

Cloudberry liqueur – like Finland’s “Lakka.”

Served with – waffles, ice cream, cheeses (like Swedish Västerbotten).

Traditional dish – served with reindeer meat or as a sauce.

Cultural Note:
In Nordic countries, cloudberries are highly prized, like seasonal treasure.

In Sweden, they’re called “hjortron”, in Norway “molte”, and in Finland “lakka.”

Nutritional Info:
High in vitamin C, antioxidants, and fiber.

Traditionally used in folk medicine for boosting immunity.
...
module.exports = { prayerPeace, meditationDigestion, sleepRoutine, cloudberry};