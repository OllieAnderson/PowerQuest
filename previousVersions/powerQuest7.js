...
function door() {
  ...
  rl.question("Do you go to the bathroom or go to the kitchen? ", (answer) => {
    ...
    // added kitchen
    // added to kitchen breakfast
    // added to kitchen lunch
    // added to kitchen dinner


    function kitchen() {
      console.log("There is a kitchen");
      rl.question("Do you make breakfast, lunch, or dinner? ", (answer) => {
        switch (answer.toLowerCase()) {
          case "breakfast":
          case "make breakfast":
            console.log("\n have a bowl of wheat biscuits.\n\n");
            rl.close();
            break;
          case "make lunch":
          case "lunch":
